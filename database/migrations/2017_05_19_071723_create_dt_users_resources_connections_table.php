...
class CreateDtUsersResourcesConnectionsTable extends Migration {
	...
	public function up()
	{
		Schema::create('dt_users_resources_connections', function(Blueprint $table)
		{
			...
			$table->timestamps();
			$table->softDeletes();
			$table->string('user_id', 36)->index('fk_dt_users_resources_connections_users1_idx');
			$table->string('resources_id', 36)->index('fk_dt_users_resources_connections_dt_resources1_idx');
		});
	}
